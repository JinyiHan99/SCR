...
# ====== 日志设置 ======
LOG_DIR="/mnt/bn/hjy/Correct-Reasoning/logs/1211"
mkdir -p ${LOG_DIR}
LOG_FILE="${LOG_DIR}/qwen2.5_3B_gen_critic_revise_merge_$(date +'%Y%m%d_%H%M%S').log"
...
export WANDB_RUN_NAME="gen_critic_revise_merge_1209_qwen2.5_3B"
...
llamafactory-cli train \
    ...
    --output_dir /mnt/bn/hjy/models/correct_hjy/qwen2.5-3B/gen_critic_revise_merge_1209 \
