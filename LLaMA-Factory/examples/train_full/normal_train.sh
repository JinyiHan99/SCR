...
# ====== 日志设置 ======
LOG_DIR="/mnt/bn/hjy/Correct-Reasoning/logs/1212"
mkdir -p ${LOG_DIR}
LOG_FILE="${LOG_DIR}/gen_critic_revise_merge_nospecial_tokens_$(date +'%Y%m%d_%H%M%S').log"
...
export WANDB_RUN_NAME="gen_critic_revise_1212_nospecial_tokens"
...
# MODEL_PATH=/mnt/bn/hjy/models/Qwen/Qwen2.5-7B
MODEL_PATH=/mnt/bn/hjy/models/Qwen/Qwen2.5-7B_special_tokens_only_masked
...
llamafactory-cli train \
    ...
    --output_dir /mnt/bn/hjy/models/correct_hjy/qwen2.5-7B/gen_critic_revise_merge_1212_nospecial_tokens \
